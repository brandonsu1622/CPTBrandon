	...
	public static void quiz1(Console con){ 
		...
		for(introw2 = 0; introw2 < intquestions - 1; introw2++) {
		 ...
		 for(intloop = 0; intloop < intquestions; intloop++){
			 dblavg = Math.round (((double) intcorrectanswer /(double) intquestions) * 100 * 100) / 100;
	 ...
	 public static void quiz2 (Console con){ 
	  ...
	  public static void quiz4 (Console con){ 
		...
		/*public static void newquiz(Console con, String fileName) {
		...
		TextInputFile newquiz = new TextInputFile(fileName);
		strnewquiz = new String [intquestions][7];
		while(newquiz.eof() == false){
			String strrandnum; 
			int introw; 
			...
			for(introw = 0; introw < intquestions; introw++){ 
				...
				strnewquiz[introw][0] = newquiz.readLine(); 
				strnequiz[introw][1] = newquizreadLine(); 
				strnewquiz[introw][2] = newquiz.readLine(); 
				strnewquiz[introw][3] = newquizreadLine(); 
				strnewquiz[introw][4] = newquizreadLine(); 
				strnewquiz[introw][5] = newquiz.readLine(); 
				strnewquiz[introw][6] = strrandnum; 
			}
		}
		...
		//bubble sort 
		 newquiz = new TextInputFile(fileName);
		//for(int intcount = 0; intcount < intquestions; intcount++){ 
			//con.println(strstraykids[intcount][0]);
		//}
		//temperory variables 
		...
		for(introw2 = 0; introw2 < intquestions - 1; introw2++) {
			...
			for(introw1 = 0; introw1 < intquestions - 1 - introw2; introw1++) { 
				 ...
				 if(Integer.parseInt(strnewquiz[introw1][6]) > Integer.parseInt(strnewquiz[introw1 + 1][6])){
					 
					 
					 strtempquestion = strnewquiz[introw1][0];
					 strtempans1 = strnewquiz[introw1][1]; 
					 strtempans2 = strnewquiz[introw1][2];  
					 strtempans3 = strnewquiz[introw1][3]; 
					 strtempans4 = strnewquiz[introw1][4];
					 strtempans = strnewquiz[introw1][5];
					 strrand = strnewquiz[introw1][6];
					 
					 strnewquiz[introw1][0] = strnewquiz[introw1 + 1][0];
					 strnewquiz[introw1][1] = strnewquiz[introw1 + 1][1]; 
					 strnewquiz[introw1][2] = strnewquiz[introw1 + 1][2];  
					 strnewquiz[introw1][3] = strnewquiz[introw1 + 1][3]; 
					 strnewquiz[introw1][4] = strnewquiz[introw1 + 1][4];
					 strnewquiz[introw1][5] = strnewquiz[introw1 + 1][5];
					 strnewquiz[introw1][6] = strnewquiz[introw1 + 1][6];
					
					 strnewquiz[introw1 + 1][0] = strtempquestion;				
					 strnewquiz[introw1 + 1][1] = strtempans1; 
					 strnewquiz[introw1 + 1][2] = strtempans2; 
					 strnewquiz[introw1 + 1][3] = strtempans3; 
					 strnewquiz[introw1 + 1][4] = strtempans4; 
					 strnewquiz[introw1 + 1][5] = strtempans; 
					 strvalorant[introw1 + 1][6] = strrand; 
